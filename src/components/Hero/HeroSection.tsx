            ...
            <Box id="home" width="100%" height="100vh" position="relative" color="#fff" className="background">
                ...
                <Box textAlign="center" display="flex" alignItems="center" justifyContent="center" width="100%" height="100%">
                    <Box>
                        ...
                        <Text as="h1" color="#fff" fontWeight="600" fontSize="3rem" marginBottom="2rem">
                            George Allen Barnas
                        </Text>
                        <Text as="p" className="typed" fontSize="1.5rem" fontWeight="300">
                            <Text as="span" className="text-slider-items" fontSize="2rem">
                                Am a{" "}
                            </Text>
                        ...
                        <Text color="white" fontWeight="300" fontSize="2rem">I enjoy building and designing for the web</Text>
                        {/* <p className="pt-3">
